...
/// external Staff_Table): <see cref="StaffNumber"/> is a plain int, deliberately NOT a foreign key,
...
public class WorkflowAssignment
{
    ...
    /// <summary>The company staff number (Staff_Table."Staff number"). Not an FK — see class remarks.</summary>
